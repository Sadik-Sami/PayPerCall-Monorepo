		...
		<section className={cn('relative overflow-hidden py-16 lg:py-24', className)}>
			...
			<motion.div
				...
				<div className='space-y-6'>
					...
					<motion.p variants={itemAnimation} className='max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg'>
						Reference-driven campaign systems that combine bid control, audience quality, and conversion intent to improve CAC and scale confidently.
					</motion.p>

					<motion.div variants={itemAnimation} className='flex flex-wrap gap-3'>
					...
					<div className='grid gap-3 sm:grid-cols-3'>
						{METRICS.map((metric) => (
							<motion.div
								...
								<div className='mt-1 text-xs font-semibold uppercase tracking-wide text-muted-foreground'>{metric.label}</div>
							</motion.div>
						))}
					</div>
				</div>

				<motion.aside variants={itemAnimation} className='rounded-3xl border border-pastel-lilac-border bg-pastel-lilac/45 p-4 shadow-sm'>
					<div className='rounded-2xl border border-border/50 bg-background/85 p-5'>
						<div className='mb-4 flex items-center justify-between'>
							<div className='text-xs font-semibold uppercase tracking-[0.14em] text-pastel-sky-ink'>Optimizing Bids</div>
							<div className='text-[10px] font-semibold uppercase tracking-[0.14em] text-muted-foreground'>Real-Time Feed</div>
						</div>
						<div className='relative mx-auto flex size-52 items-center justify-center rounded-full border border-border/60 bg-background/90'>
							...
							<div className='text-center'>
								...
								<div className='mt-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-muted-foreground'>Efficiency</div>
							</div>
						</div>
					</div>
