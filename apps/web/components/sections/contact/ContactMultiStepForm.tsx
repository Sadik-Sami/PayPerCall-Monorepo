    ...
    <section id='contact-form' className='w-full bg-background py-14 sm:py-16 md:py-20'>
      <div className='section-container grid gap-7 lg:grid-cols-[1.05fr_1.2fr] lg:items-start'>
        <motion.aside
          ...
          className='rounded-3xl border border-pastel-lime-border/80 bg-pastel-lime/60 p-6 shadow-sm dark:bg-card/80 md:p-8 lg:sticky lg:top-24'
        >
          ...
          <p className='mt-3 text-sm leading-relaxed text-muted-foreground sm:text-base'>
            This multi-step form captures your goals, service priorities, and meeting context so your first call is already
            productive.
          </p>
          ...
          <div className='mt-6 space-y-3'>
            ...
            <div className='flex items-start gap-3 rounded-xl border border-border/70 bg-card/75 p-3'>
              ...
              <div>
                ...
                <p className='text-xs text-muted-foreground'>No long-term commitment required to start the conversation.</p>
              </div>
            </div>
          </div>
        </motion.aside>
              ...
              <div className='flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between'>
                <div>
                  <p className='text-xs font-semibold uppercase tracking-wide text-primary'>
                    {activeTab === 'contact' ? 'Step 1' : activeTab === 'services' ? 'Step 2' : 'Step 3'}
                  </p>
                ...
                <form className='space-y-5'>
                  ...
                  <div className='flex flex-wrap items-center justify-between gap-3 border-t border-border/60 pt-5'>
                    <span className='text-xs text-muted-foreground'>
                      You can review all answers before submitting.
                    </span>
                          ...
                          <div className='flex items-start gap-3'>
                            ...
                            <div>
                              <FormLabel className='text-sm font-medium leading-snug'>
                                I agree to be contacted regarding this inquiry and understand this form is a consultation
                                request.
                              </FormLabel>
