...
import { PORTFOLIO_TRUST_PILLS, PORTFOLIO_SERVICE_CHIPS } from '../_data/portfolio-content';
			...
			<div className='section-container relative z-10'>
				<div className='mx-auto max-w-4xl text-center'>
					...
					<h1 className='mt-6 font-heading text-4xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-6xl'>
						A performance partner built around accountable growth and delivery
					</h1>
					<p className='mx-auto mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg'>
						Core Closer connects acquisition strategy, pay-per-call and pay-per-lead operations, digital marketing, engineering,
						reporting, and compliance into one operating model.
					</p>

					<div className='mt-7 flex flex-wrap items-center justify-center gap-2 text-sm'>
						{PORTFOLIO_TRUST_PILLS.map((item) => (
							<span
								key={item}
