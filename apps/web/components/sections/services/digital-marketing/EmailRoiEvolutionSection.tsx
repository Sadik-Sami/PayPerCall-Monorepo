		...
		<section className={cn('w-full py-14 md:py-18', className)}>
			<div className='section-container'>
				<motion.div
					...
					<motion.p variants={itemVariants} className='mt-4 text-lg leading-relaxed text-muted-foreground'>
				...
				<motion.div
					...
					className='mt-12 grid grid-cols-1 gap-7 lg:grid-cols-2'>
					<motion.article
						variants={cardVariants}
						className='relative overflow-hidden rounded-3xl border border-border bg-muted/35 p-7 md:p-8'>
						<div className='relative z-10'>
							...
							<h3 className='mt-4 text-4xl font-bold tracking-tight text-foreground'>The Funnel Leak</h3>
						...
						<div className='relative z-10 mt-7 space-y-5'>
							...
							<div className='relative rounded-2xl border border-destructive/20 bg-card/75 p-4'>
								...
								{LEAK_STAGES.map((stage, index) => {
									...
									return (
										<div key={stage.label} className={cn(index > 0 && 'mt-4', 'relative rounded-xl border border-border/60 bg-background/70 p-4')}>
					...
					<motion.article
						variants={cardVariants}
						className='relative overflow-hidden rounded-3xl border border-pastel-sky-border bg-card p-7 shadow-sm md:p-8'>
						...
						<div className='relative z-10'>
							...
							<h3 className='mt-4 text-4xl font-bold tracking-tight text-foreground'>Retention Infrastructure</h3>
						...
						<div className='relative z-10 mt-7 grid grid-cols-2 gap-4'>
							<div className='col-span-2 rounded-2xl border border-pastel-peach-border bg-pastel-peach/60 p-5'>
								<div className='inline-flex items-center gap-2 text-sm font-semibold text-foreground'>
									<Database className='size-4 text-pastel-peach-ink' aria-hidden />
									360deg Customer View
								</div>
								<p className='mt-2 text-sm text-muted-foreground'>Unified subscriber profile across ESP, CRM, and purchase behavior.</p>
								<div className='mt-5 flex items-baseline gap-2'>
									<span className='text-4xl font-black tracking-tight text-foreground'>+124%</span>
									<span className='text-xs font-bold uppercase tracking-[0.14em] text-pastel-mint-ink'>Avg LTV Increase</span>
								</div>
							</div>
				...
				<motion.div
					...
					<div className='relative z-10 flex flex-col gap-6 md:flex-row md:items-center md:justify-between'>
						<div className='max-w-xl'>
							<h4 className='text-3xl font-bold tracking-tight text-white'>The Difference Is Infrastructure</h4>
