...
export const DIGITAL_MARKETING_GATEWAY_CONFIG: GatewaySectionConfig = {
	...
	columns: 2,
	ctaLabels: {
		'/services/digital-marketing/seo': 'Explore SEO & Content',
		'/services/digital-marketing/ppc': 'Explore Paid Media',
		'/services/digital-marketing/email': 'Explore Lifecycle',
		'/services/digital-marketing/social': 'Explore Social Signal',
	},
	iconKeys: {
		'/services/digital-marketing/seo': 'Sparkles',
		'/services/digital-marketing/ppc': 'Zap',
		'/services/digital-marketing/email': 'Users',
		'/services/digital-marketing/social': 'Globe',
	},
};
